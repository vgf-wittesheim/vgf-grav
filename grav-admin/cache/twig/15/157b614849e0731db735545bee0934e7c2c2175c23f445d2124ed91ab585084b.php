...
class __TwigTemplate_3e4f5a8011b25a96fd93811436d68d2d6a0b5fe60151a5df20e7451f977354cb extends Twig_Template
{
...
($context["field"] ?? null), "active", array())) {
            // line 6
            echo "    ";
        ...
        if ($this->getAttribute(($context["field"] ?? null), "fields", array())) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["tab"]) {
                ...
                if ((($this->getAttribute($context["tab"], "type", array()) == "tab") && (twig_test_empty($this->getAttribute($context["tab"], "security", array())) || $this->env->getExtension('Grav\Common\Twig\TwigExtension')->authorize($this->env->getExtension('Grav\Common\Twig\TwigExtension')->arrayFunc($this->getAttribute($context["tab"], "security", array())))))) {
                    ...
                    echo (((($this->getAttribute(($context["storedValue"] ?? null), ("tab-" . ($context["tabsKey"] ?? null))) == (($context["scope"] ?? null) . $this->getAttribute($context["tab"], "name", array()))) || (($context["active"] ?? null) == $this->getAttribute($context["loop"], "index", array())))) ? ("checked=\"checked\"") : (""));
                    echo "/>
        <label for=\"tab-";
                    // line 17
                    echo twig_escape_filter($this->env, (($context["tabsKey"] ?? null) . $this->getAttribute($context["loop"], "index", array())), "html", null, true);
...
";
    ...
    {
        return new Twig_Source("<div class=\"form-tabs {{ field.class }}\">
...
", "forms/fields/tabs/tabs.html.twig", "/var/www/html/user/plugins/admin/themes/grav/templates/forms/fields/tabs/tabs.html.twig");
    }
}
