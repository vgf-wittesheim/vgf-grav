...
/* pages.html.twig */
class __TwigTemplate_7c40348f3987f62e0ecda543d66461e2549a321c8ff33a0c1539e151afaf2207 extends Twig_Template
{
...
($context["context"] ?? null)) {
        ...
        // line 45
        $context["preview_link"] = (($this->getAttribute(($context["context"] ?? null), "routable", array())) ? ((("<a class=\"button\" target=\"_blank\" href=\"" . ($context["preview_html"] ?? null)) . "\"> <i class=\"fa fa-fw fa-eye\" style=\"font-size:18px;margin-right:0;\"></i></a>")) : (""));
        // line 1
...
($context["mode"] ?? null) == "edit")) {
            ...
            ";
            // line 195
            echo twig_escape_filter($this->env, (($this->getAttribute(($context["context"] ?? null), "exists", array())) ? ($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.EDIT")) : ($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.CREATE"))), "html", null, true);
            echo " <i>";
    ...
    ";
        ...
        if ((($context["mode"] ?? null) == "new")) {
            // line 205
            echo "        ";
            $this->loadTemplate("partials/blueprints-new.html.twig", "pages.html.twig", 205)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["admin"] ?? null), "blueprints", array(0 => "pages/page"), "method"), "data" => ($context["context"] ?? null))));
            // line 206
            echo "    ";
                ...
                if ((($context["exists"] ?? null) && (twig_length_filter($this->env, $this->getAttribute(($context["context"] ?? null), "translatedLanguages", array())) > 1))) {
                    ...
                    foreach ($context['_seq'] as $context["language"] => $context["route"]) {
                        ...
                        if (($context["language"] != ($context["page_lang"] ?? null))) {
                            ...
                            echo "\" redirect=\"";
                            echo twig_escape_filter($this->env, trim($this->getAttribute(($context["context"] ?? null), "rawRoute", array()), "/"), "html", null, true);
            ...
            if (($this->getAttribute($this->getAttribute(($context["context"] ?? null), "blueprints", array()), "fields", array()) && ($this->getAttribute($this->getAttribute(($context["admin"] ?? null), "session", array()), "expert", array()) == "0"))) {
                // line 254
                echo "                ";
                $this->loadTemplate("partials/blueprints.html.twig", "pages.html.twig", 254)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["context"] ?? null), "blueprints", array()), "data" => ($context["context"] ?? null))));
                // line 255
                echo "            ";
            } else {
                // line 256
                echo "                ";
                $this->loadTemplate("partials/blueprints-raw.html.twig", "pages.html.twig", 256)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["admin"] ?? null), "blueprints", array(0 => (("admin/pages/" . ($context["modular"] ?? null)) . "raw")), "method"), "data" => ($context["context"] ?? null))));
                // line 257
                echo "            ";
            }
            // line 258
    ...
    ";
        ...
        <div class=\"remodal\" data-remodal-id=\"modal\" data-remodal-options=\"hashTracking: false\">
            ";
            // line 284
            $this->loadTemplate("partials/blueprints-new.html.twig", "pages.html.twig", 284)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["admin"] ?? null), "blueprints", array(0 => "admin/pages/new"), "method"), "data" => ($context["context"] ?? null))));
            // line 285
            echo "        </div>
        ...
        <div class=\"remodal\" data-remodal-id=\"modal-folder\" data-remodal-options=\"hashTracking: false\">
            ";
            // line 288
            $this->loadTemplate("partials/blueprints-new-folder.html.twig", "pages.html.twig", 288)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["admin"] ?? null), "blueprints", array(0 => "admin/pages/new_folder"), "method"), "data" => ($context["context"] ?? null))));
            // line 289
            echo "        </div>
        ...
        <div class=\"remodal\" data-remodal-id=\"modular\" data-remodal-options=\"hashTracking: false\">
            ";
            // line 292
            $this->loadTemplate("partials/blueprints-new.html.twig", "pages.html.twig", 292)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["admin"] ?? null), "blueprints", array(0 => "admin/pages/modular_new"), "method"), "data" => ($context["context"] ?? null))));
            // line 293
            echo "        </div>
    ...
    ";
        ...
        ";
            // line 300
            $this->loadTemplate("partials/page-move.html.twig", "pages.html.twig", 300)->display(array_merge($context, array("blueprints" => $this->getAttribute(($context["admin"] ?? null), "blueprints", array(0 => "admin/pages/move"), "method"), "data" => ($context["context"] ?? null))));
            // line 301
            echo "    </div>
    <div class=\"remodal\" data-remodal-id=\"revisions\" data-remodal-options=\"hashTracking: false\">
        ";
            // line 303
            $this->loadTemplate(array(0 => "partials/page-revisions.html.twig", 1 => "empty.html.twig"), "pages.html.twig", 303)->display(array_merge($context, array("data" => ($context["context"] ?? null))));
            // line 304
            echo "    </div>
    ";
        }
...
";
    ...
    ";
            // line 56
            if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "content", array()), "order", array()), "by", array())) {
                // line 57
                echo "        ";
                $context["pcol"] = $this->getAttribute($this->getAttribute(($context["page"] ?? null), "children", array(), "method"), "order", array(0 => $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "content", array()), "order", array()), "by", array()), 1 => $this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["page"] ?? null), "header", array()), "content", array()), "order", array()), "dir", array())), "method");
                // line 58
                echo "    ";
            } elseif ($this->getAttribute(($context["page"] ?? null), "order_by", array())) {
                // line 59
                echo "        ";
                $context["pcol"] = $this->getAttribute($this->getAttribute(($context["page"] ?? null), "children", array(), "method"), "order", array(0 => $this->getAttribute(($context["page"] ?? null), "order_by", array()), 1 => $this->getAttribute(($context["page"] ?? null), "order_dir", array())), "method");
                // line 60
                echo "    ";
            } else {
                // line 61
...
$context["p"], "published", array())) ? (($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.PUBLISHED") . " &bull; ")) : (($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.NON_PUBLISHED") . " &bull; "))));
        ...
        <li class=\"page-item\" data-nav-id=\"";
            ...
            <div class=\"row\">
                ...
                <span data-hint=\"";
                // line 82
                echo trim(($context["description"] ?? null), " &bull; ");
