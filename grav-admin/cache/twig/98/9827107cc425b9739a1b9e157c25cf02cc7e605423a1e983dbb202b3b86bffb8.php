...
class __TwigTemplate_a4544fc4ddbe7fb08818321a01f4fbcd128f9bbbae60f56cf3e7b94865e1fda9 extends Twig_Template
{
    ...
    {
        // line 1
        $context["taxonomies"] = (((null === ($context["taxonomies"] ?? null))) ? ($this->getAttribute($this->getAttribute(($context["admin"] ?? null), "data", array(0 => "config/site"), "method"), "taxonomies", array())) : (($context["taxonomies"] ?? null)));
        // line 2
...
";
    ...
    ";
            // line 6
            $context["value"] = $this->env->getExtension('Grav\Common\Twig\TwigExtension')->arrayFunc((($this->getAttribute(($context["data"] ?? null), "value", array(0 => ("header.taxonomy." . $context["name"])), "method", true, true)) ? (_twig_default_filter($this->getAttribute(($context["data"] ?? null), "value", array(0 => ("header.taxonomy." . $context["name"])), "method"), array())) : (array())));
            // line 7
            echo "    ";
            ...
            // line 8
            echo "    ";
            $context["list"] = array_unique(twig_array_merge(twig_array_merge(array(), ($context["sub_taxonomies"] ?? null)), ($context["value"] ?? null)));
            // line 9
            echo "
    ";
            // line 10
...
{% endfor %}
", "forms/fields/taxonomy/taxonomy.html.twig", "/var/www/html/user/plugins/admin/themes/grav/templates/forms/fields/taxonomy/taxonomy.html.twig");
    }
}
