...
class __TwigTemplate_cf04f5ebf847ae2a0bb1ea31cf7f9086a0c630ea01423f80eefae1c4e575b502 extends Twig_Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 2
        $context["siblings"] = $this->getAttribute($this->getAttribute($this->getAttribute(($context["data"] ?? null), "parent", array()), "children", array()), "visible", array());
        // line 3
        echo "
<div class=\"form-field grid pure-g\">
    ...
    <div class=\"form-data block size-2-3 pure-u-2-3\">
        ...
        echo "\">
            ";
        // line 17
        $context["canReorder"] = ( !$this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["data"] ?? null), "parent", array()), "header", array()), "content", array()), "items", array()) && $this->getAttribute(($context["data"] ?? null), "visible", array()));
        // line 18
        echo "            <input
                type=\"hidden\"
                data-order
        ...
        echo "\"
                value=\"";
        // line 23
        echo twig_escape_filter($this->env, ((($context["canReorder"] ?? null)) ? (($context["value"] ?? null)) : ("")), "html", null, true);
        echo "\" />
            ";
        // line 24
        if ($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["data"] ?? null), "parent", array()), "header", array()), "content", array()), "items", array())) {
            // line 25
...
($context["data"] ?? null), "visible", array())) {
            // line 27
            echo "                <span class=\"note\">";
...
\t\t\t    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["page"]) {
                // line 33
                echo "\t\t\t\t\t<li class=\"";
                if ((($this->getAttribute($context["page"], "order", array()) == ($context["value"] ?? null)) && ($context["canReorder"] ?? null))) {
                    echo "drag-handle";
                } else {
                    echo "ignore";
                }
