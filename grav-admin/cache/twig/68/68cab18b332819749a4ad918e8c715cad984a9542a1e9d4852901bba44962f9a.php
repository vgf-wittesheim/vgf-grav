...
class __TwigTemplate_3b917d3b851c44f2e63935c3fa86ba1def7a6059a70be1332ac4ecbe0d49be49 extends Twig_Template
{
    ...
    public function getrenderer($__key__ = null, $__text__ = null, $__field__ = null, $__scope__ = null, ...$__varargs__)
    {
        ...
        ";
            ...
            if (($this->getAttribute(($context["field"] ?? null), "value_only", array()) != true)) {
                ...
                // line 18
                echo "            ";
                $context["key"] = twig_replace_filter(($context["key"] ?? null), array("%5B" => "[", "%5D" => "]"));
                // line 19
                echo "
            <input
                data-grav-array-type=\"key\"
