...
class __TwigTemplate_35f76ce716393f9376ed17b30cecd3b8932c2a95264a4378c87dab49a069d9d7 extends Twig_Template
{
...
";
    ...
    <div class=\"switch-toggle switch-grav ";
        ...
        foreach ($context['_seq'] as $context["key"] => $context["text"]) {
            ...
            // line 34
            echo "            ";
            $context["translation"] = trim((($this->getAttribute($this->getAttribute($this->getAttribute($this->getAttribute(($context["grav"] ?? null), "twig", array(), "any", false, true), "twig", array(), "any", false, true), "filters", array(), "any", false, true), "tu", array(), "array", true, true)) ? ($this->env->getExtension('Grav\Plugin\Admin\AdminTwigExtension')->tuFilter($context["text"])) : ($this->env->getExtension('Grav\Common\Twig\TwigExtension')->translate($context["text"]))));
            // line 35
            echo "
            <input type=\"radio\"
                value=\"";
...
array_key_exists("value", $context) && (($context["key"] == 1) || ($context["key"] == "1")))) {
            ...
            echo twig_escape_filter($this->env, ($context["id"] ?? null), "html", null, true);
            echo "\">";
            echo trim($this->getAttribute($this, "spanToggle", array(0 => ($context["translation"] ?? null), 1 => ($context["maxLen"] ?? null)), "method"));
            echo "</label>
        ";
        }
        $_parent = $context['_parent'];
...
{% endblock %}
", "forms/fields/toggle/toggle.html.twig", "/var/www/html/user/plugins/admin/themes/grav/templates/forms/fields/toggle/toggle.html.twig");
    }
}
